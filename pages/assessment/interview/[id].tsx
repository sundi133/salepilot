      ...
      {userPressedContinue ? (
        <AnimatePresence>
          <div className="p-4 md:p-10 mx-auto max-w-7xl flex flex-col px-2 pt-2 pb-2 md:px-2 md:py-2 relative overflow-x-hidden">
                  ...
                  <div className="w-[800px] mx-auto">
                    <motion.div className="">
                      <div className="interview-info bg-white rounded-lg shadow px-6 py-4">
                        <h4 className="text-xl font-semibold text-[#1D2B3A] mb-2">
                          Loading your interview... Please wait
                        </h4>
                      </div>
                    </motion.div>
                  </div>
            ...
            {completed ? (
              <div className="w-full flex flex-col max-w-[1000px] mx-auto overflow-y-auto pb-8 md:pb-12"></div>
            ) : (
              <div className="h-full w-full items-center flex flex-col mt-2">
                {recordingPermission ? (
                  <div className="w-full flex flex-col max-w-[1000px] mx-auto justify-start">
                    <motion.div
                      initial={{ y: -20 }}
                      animate={{ y: 0 }}
                      transition={{
                    ...
                    {/* {capturing ? (
                      <div className="mt-2 w-full">
                        <select
                          ...
                          value={language}
                          className="w-full border justify-end rounded p-2 focus:outline-none focus:ring focus:border-blue-300 mb-2"
                        >
        ...
        <AnimatePresence>
          <div className="w-full min-h-screen flex flex-col justify-center items-center bg-[#FCFCFC] relative overflow-x-hidden">
            <h2 className="text-l font-semibold text-[#1D2B3A] text-center"></h2>
            <div className="bg-[#FCFCFC] p-2 md:p-4 mx-auto flex flex-col">
              <motion.div className="justify-center">
                <span className="text-sm">
                  Please ensure your camera & microphone is enabled on the next
                  page. Ensure the network connection is stable. Be in a quiet
                  environment.
                </span>
              </motion.div>
            </div>
            <div className="w-[400px] mx-auto text-lg">
              <button
                onClick={handleContinueButtonSubmit}
                className="w-full text-xl bg-gray-900 text-white rounded-md py-2 hover:bg-gray-700"
              >
                {isLoading && (
            ...
            {!isLoading ? (
              <div className="mt-4 text-left text-sm text-[#1D2B3A] mb-4">
                <div className="w-full flex flex-col max-w-[1000px] mx-auto justify-center">
                  <ul>
                    <li>Works best on Chrome and Firefox.</li>
                  </ul>
                  <p className="text-gray-600 mt-3 italic"></p>
                </div>
              </div>
            ) : (
              <div className="mt-4 text-left text-lg text-[#1D2B3A] mb-4">
                <div className="w-full flex flex-col max-w-[640px] mx-auto justify-center">
                  <ul>
                    <li>Loading your interview... Please wait</li>
                  </ul>
                  <p className="text-gray-600 mt-3 italic"></p>
                </div>
              </div>
